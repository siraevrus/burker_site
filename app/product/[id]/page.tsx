...
export default function ProductPage({
  ...
  // Генерируем изображения для галереи (используем одно изображение для всех)
      ...
      <section className="mt-16 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-lg font-semibold">447 Отзывов</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <div className="mb-2">
                <p className="font-semibold text-sm mb-1">A. B.</p>
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
              ...
              <p className="text-sm text-gray-600 mb-2">Gold</p>
              <p className="text-sm text-gray-700 line-clamp-4">
                Очень красивый набор собрала, браслеты очень красивые и часы на
                руке смотрятся очень стильно спасибо за оперативность и качество!
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <div className="mb-2">
                <p className="font-semibold text-sm mb-1">O. 3.</p>
                <div className="flex gap-1">
                  {[...Array(4)].map((_, i) => (
                    <svg
                      key={i}
              ...
              <p className="text-sm text-gray-600 mb-2">Gold</p>
              <p className="text-sm text-gray-700 line-clamp-4">
                Отличный браслет. Ношу с часами, как комплект. Рекомендую!
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <div className="mb-2">
                <p className="font-semibold text-sm mb-1">M. У.</p>
                <div className="flex gap-1">
                  {[...Array(4)].map((_, i) => (
                    <svg
                      key={i}
              ...
              <p className="text-sm text-gray-600 mb-2">Gold</p>
              <p className="text-sm text-gray-700 line-clamp-4">
                Собрала такое комбо! Браслет и часы, получилось гармонично.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <div className="mb-2">
                <p className="font-semibold text-sm mb-1">Н. Ш.</p>
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
              ...
              <p className="text-sm text-gray-600 mb-2">Gold</p>
              <p className="text-sm text-gray-700 line-clamp-4">
                Друг подарил мне эти часы и браслеты и заказал их для меня в
                качестве новогоднего подарка. Я давно мечтал о таких часах, и с
                браслетами они смотрятся просто потрясающе.
              </p>
            </div>
          </div>
        </div>
