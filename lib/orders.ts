...
export function mapOrderFromDb(dbOrder: any): Order {
  return {
    ...
    deliveryToRussiaRub: dbOrder.deliveryToRussiaRub ?? undefined,
    customsOrderDate: dbOrder.customsOrderDate ?? undefined,
    cbrEurRubOnOrderDate: dbOrder.cbrEurRubOnOrderDate ?? undefined,
